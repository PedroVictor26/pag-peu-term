  ...
  return (
    <>
      ...
      <main>
        ...
        {/* ── CARROS-CHEFE: WHATSAPP + NAVEGADOR ─────────────────────────── */}
          ...
          <div className="mx-auto max-w-7xl px-6 py-20 md:px-10 md:py-28">
            <div className="mb-14 flex flex-col gap-3 border-b border-[color:var(--color-rule)] pb-10">
              ...
              <h2 className="headline-section">
                Dois recursos que{' '}
                <em style={{ color: 'var(--color-accent)' }}>ninguém esperava</em>.
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-6 border border-[color:var(--color-rule-strong)] bg-[color:var(--color-bg)] p-8 transition hover:border-[color:var(--color-accent)]">
                ...
                <div>
                  <h3 className="headline-section" style={{ fontSize: 'clamp(1.75rem, 3vw, 2.5rem)' }}>
                    <em style={{ color: 'var(--color-accent)', fontStyle: 'italic' }}>WhatsApp Web</em>{' '}
                    embutido
                  </h3>
                  <p className="mt-4 text-[15px] leading-relaxed text-[color:var(--color-ink-muted)]">
                    Responde clientes sem sair do terminal. Abre num painel lateral — você continua no Claude Code, o WhatsApp fica ali do lado. Chega de Alt+Tab.
                  </p>
                </div>

                {/* Terminal art mostrando o recurso */}
                <TerminalMockup
                  label="peu-term — whatsapp"
                  lines={[
                    '// Painel lateral aberto',
                    '$ peu whatsapp --panel right',
                    '',
                    '● WhatsApp Web carregado',
                    '  3 mensagens não lidas',
                    '  → respondendo sem sair do app',
                  ]}
                />

                <ul className="space-y-2 text-[13px] text-[color:var(--color-ink-muted)]">
                  {[
                    'Abre no painel lateral — não sai do terminal',
                    'Funciona junto com Claude Code, Gemini, Codex',
                    'Sem trocar de janela, sem perder o contexto',
                  ].map((t) => (
              ...
              <div className="flex flex-col gap-6 border border-[color:var(--color-rule-strong)] bg-[color:var(--color-bg)] p-8 transition hover:border-[color:var(--color-accent)]">
                ...
                <div>
                  <h3 className="headline-section" style={{ fontSize: 'clamp(1.75rem, 3vw, 2.5rem)' }}>
                    <em style={{ color: 'var(--color-accent)', fontStyle: 'italic' }}>Navegador</em>{' '}
                    no split
                  </h3>
                  <p className="mt-4 text-[15px] leading-relaxed text-[color:var(--color-ink-muted)]">
                    Abra qualquer site ou painel num split — com barra de endereço, histórico, sem abrir Chrome. Vercel dashboard, docs, Railway, ClickUp — tudo dentro do app.
                  </p>
                </div>

                {/* Terminal art */}
                <TerminalMockup
                  label="peu-term — browser"
                  lines={[
                    '$ peu open vercel.com/dashboard',
                    '',
                    '// Abrindo no split direito...',
                    '● vercel.com/dashboard',
                    '  ← → ↺  barra de endereço ativa',
                ...
                <ul className="space-y-2 text-[13px] text-[color:var(--color-ink-muted)]">
                  {[
                    'Barra de endereço completa + histórico',
                    'Split horizontal ou vertical — você escolhe',
                    'Qualquer site: docs, dashboards, Railway, Vercel',
                  ].map((t) => (
                    <li key={t} className="flex items-start gap-2">
                      <Check className="mt-1 h-3 w-3 flex-shrink-0 text-[color:var(--color-accent)]" strokeWidth={2.5} />
                      {t}
            ...
            <div className="mb-14 flex flex-col gap-4 border-b border-[color:var(--color-rule)] pb-10 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h2 className="headline-section mt-4">
                  E mais <em style={{ color: 'var(--color-accent)' }}>8 adições</em>.
                </h2>
              </div>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              ...
              <div className="flex flex-col gap-6 border border-[color:var(--color-rule-strong)] p-8">
                ...
                <p className="text-[15px] leading-relaxed text-[color:var(--color-ink-muted)]">
                  Comprou qualquer versão do Peu-Term? A v0.8.0 já tá no seu app. É só abrir — o auto-update entregou enquanto você dormia. Nenhum centavo extra.
                </p>
                <TerminalMockup
                  label="auto-update"
                  lines={[
        ...
        <section className="border-b border-[color:var(--color-rule)]">
          <div className="mx-auto max-w-7xl px-6 py-24 text-center md:px-10 md:py-36">
            ...
            <p className="mx-auto mt-6 max-w-lg text-base leading-relaxed text-[color:var(--color-ink-muted)]">
              WhatsApp Web + navegador dentro do terminal, SSH, fuzzy finder, biblioteca de prompts — e tudo que vier depois. Compra uma vez, usa pra sempre.
            </p>
